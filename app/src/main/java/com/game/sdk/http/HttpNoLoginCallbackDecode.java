 ...
 */
@NotProguard
public abstract class HttpNoLoginCallbackDecode<E>  extends HttpCallback {
    private static final String TAG = HttpNoLoginCallbackDecode.class.getSimpleName();
    ...
    public HttpNoLoginCallbackDecode(Context activity, String authkey) {
